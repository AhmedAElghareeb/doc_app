...
mixin _$LoginState<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(Successs<T> value) success,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(Successs<T> value)? success,
...
/// @nodoc
abstract class _$$SuccesssImplCopyWith<T, $Res> {
  factory _$$SuccesssImplCopyWith(
          _$SuccesssImpl<T> value, $Res Function(_$SuccesssImpl<T>) then) =
      __$$SuccesssImplCopyWithImpl<T, $Res>;
  @useResult
  $Res call({T data});
}

/// @nodoc
class __$$SuccesssImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$SuccesssImpl<T>>
    implements _$$SuccesssImplCopyWith<T, $Res> {
  __$$SuccesssImplCopyWithImpl(
      _$SuccesssImpl<T> _value, $Res Function(_$SuccesssImpl<T>) _then)
      : super(_value, _then);
...
class _$SuccesssImpl<T> implements Successs<T> {
  const _$SuccesssImpl(this.data);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SuccesssImplCopyWith<T, _$SuccesssImpl<T>> get copyWith =>
      __$$SuccesssImplCopyWithImpl<T, _$SuccesssImpl<T>>(this, _$identity);
...
abstract class Successs<T> implements LoginState<T> {
  const factory Successs(final T data) = _$SuccesssImpl<T>;
